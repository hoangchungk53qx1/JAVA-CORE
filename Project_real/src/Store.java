...
// chọn 0 là software còn 1 là sách 
		...
		int choice = Validation.CheckLimitChoice(0, 1); // bằng 1 thi laf true la book
	...
	public boolean RemoveItem() {
		...
		ShopItem itemremove = (ShopItem) Validation.findObjectFromStore(ls, id); // ham findoject dựa vào id để xóa 1
																					// sản phẩm,
	...
	public boolean update() {
		...
		Display();
		int id = Validation.checkInputInt();
		int found = Validation.findIdFromStore(ls, id);
